...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from yx.agents.fork import ForkError, build_forked_messages
        from yx.agents.parser import AgentDef
        from yx.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from yx.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from yx.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from yx.agents.fork import ForkError, build_forked_messages
        from yx.agents.parser import AgentDef
        from yx.agents.tool_filter import build_teammate_tools
        from yx.agent import Agent as AgentClass
        from yx.conversation import ConversationManager
        from yx.permissions import (
            DangerousCommandDetector,
        ...
        from yx.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from yx.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from yx.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from yx.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from yx.client import create_client
