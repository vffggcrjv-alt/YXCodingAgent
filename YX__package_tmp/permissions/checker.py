...
from yx.permissions.dangerous import DangerousCommandDetector, is_safe_command
from yx.permissions.modes import DecisionEffect, PermissionMode, mode_decide
from yx.permissions.rules import RuleEngine, extract_content
from yx.permissions.sandbox import PathSandbox
from yx.tools.base import Tool
...
class PermissionChecker:
    ...
    def _is_plan_file(self, target_path: str) -> bool:
        if not self.plan_file_path or not target_path:
            return ".yx/plans/" in target_path
        try:
