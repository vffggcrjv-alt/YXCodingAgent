...
PROJECT_AGENTS_DIR = ".yx/agents"
USER_AGENTS_DIR = "~/.yx/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("yx.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from yx.agents.parser import parse_frontmatter, _validate_agent_meta
