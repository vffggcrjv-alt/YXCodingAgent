...
from yx.teams.backend_detect import BackendDetectionError, detect_backend
from yx.teams.mailbox import Mailbox, create_message
...
from yx.teams.progress import TeammateProgress
from yx.teams.registry import AgentNameRegistry
from yx.teams.shared_task import SharedTaskStore
from yx.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from yx.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
