...
from yx.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from yx.agent import Agent
    from yx.conversation import ConversationManager
    from yx.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from yx.conversation import ConversationManager as CM
                conv = CM()
